/* =========================================================
   L'Après-Monde — éditeur de repères de carte.
   ...
   claude/dev-server.js (voir README). Sur GitHub Pages, qui ne
  ...
  saveBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      alert(
        ...
        "(node claude/dev-server.js). Utilise le bouton « Télécharger » " +
  ...
  function blockIfNotLocal() {
    ...
    document.body.innerHTML = `
      <div class="served-warning">
        ...
        <p>puis ouvre <a href="http://localhost:8080/outils/editor.html">http://localhost:8080/outils/editor.html</a></p>
