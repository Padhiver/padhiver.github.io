/* =========================================================
   L'Après-Monde — couche de données.
...
const EanaData = (() => {
  ...
  function blockIfFileProtocol() {
    ...
    // Reconstruit le chemin servi à partir du dossier "apres-monde" repéré
    // dans le chemin local — marche quelle que soit la profondeur de la
    // page (racine, site/map/, outils/…), sans cas particulier par dossier.
    const parts = window.location.pathname.split("/");
    const idx = parts.lastIndexOf("apres-monde");
    const relative = idx >= 0 ? parts.slice(idx + 1).join("/") : "";
