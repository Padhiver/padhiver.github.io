/* =========================================================
   L'Après-Monde — panneau de fiche : ouverture, fermeture, changement de
...
const EanaOverlay = (() => {
  ...
  async function open(id, { resetPage = true } = {}) {
    ...
    const renderOpts = { article, category, page: overlayPageIndex, related, banner, pages, portrait: entry.portrait };
